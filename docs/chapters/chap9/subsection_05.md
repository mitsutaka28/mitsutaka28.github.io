...
\begin{eqnarray}
    \min _{\boldsymbol{\Theta}} \max _{\boldsymbol{\Phi}} V(G, D)=\sum_{v_i \in \mathcal{V}}\left(\mathbb{E}_{v_j \sim p_{\text {true }}}(v_j v_i\right)\left[\log D(v_j, v_i ; \boldsymbol{\Phi})]\. \nonumber\\
